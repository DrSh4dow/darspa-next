  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-screen-lg [&>h2]:text-xl [&>h1]:text-2xl">
        ...
        <p>
          By accessing this Website, accessible from https://darspa.cl/, you are
        ...
        <p>
          This will let DarSpa to terminate upon violations of any of these
        ...
        <p>
          DarSpa or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          DarSpa’s Website, even if DarSpa or an authorize representative of
        ...
        <p>
          The materials appearing on DarSpa’s Website may include technical,
          typographical, or photographic errors. DarSpa will not promise that
          any of the materials in this Website are accurate, complete, or
          current. DarSpa may change the materials contained on its Website at
          any time without notice. DarSpa does not make any commitment to update
          the materials.
        </p>
        ...
        <p>
          DarSpa has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by DarSpa of the site. The use
        ...
        <p>
          DarSpa may revise these Terms of Use for its Website at any time
