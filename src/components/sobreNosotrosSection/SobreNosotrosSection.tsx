  ...
  return (
    <section>
      <div className="mx-auto max-w-screen-2xl py-20 px-2 sm:px-4 ">
        <h2 className="mb-6 text-3xl font-black text-teal-900 lg:mb-12 lg:text-5xl">
          ¿A Que Nos Dedicamos?
        </h2>
        ...
        <h5 className="mb-4 text-center text-xs font-bold text-slate-600 sm:text-sm md:mb-6 lg:mb-12">
          estudio metabólico, ajuste y control de peso corporal
        </h5>
        <div className=" mx-auto mb-4 h-[2px] w-56 bg-teal-600 sm:w-80 md:mb-6 md:w-96 lg:mb-12 lg:w-[640px]" />
        <h4 className="mb-1 text-center font-montserrat text-4xl font-bold text-slate-900">
          Ansiedad
        ...
        <h5 className="mb-4 text-center text-xs font-bold text-slate-600 sm:text-sm md:mb-6 lg:mb-12">
          ansiedad alimentaria, trastornos de la alimentación
        </h5>
        <div className="mx-auto mb-4 h-[2px] w-56 bg-teal-600 sm:w-80 md:mb-6 md:w-96 lg:mb-12 lg:w-[640px]" />
        <h4 className="mb-1 text-center font-montserrat text-4xl font-bold text-slate-900">
          Modelado Corporal
        ...
        <h5 className="mb-4 text-center text-xs font-bold text-slate-600 sm:text-sm md:mb-6 lg:mb-12">
          entrenamiento deportivo avanzado, metabolismo basal
        </h5>
        <div className="mx-auto mb-4 h-[2px] w-56 bg-teal-600 sm:w-80 md:mb-6 md:w-96 lg:mb-12 lg:w-[640px]" />
        <h4 className="mb-1 text-center font-montserrat text-4xl font-bold text-slate-900">
          Wellness
        ...
        <h5 className="mb-4 text-center text-xs font-bold text-slate-600 sm:text-sm md:mb-6 lg:mb-12">
          estilos de vida saludable, asesoria dietética avanzada
        </h5>
        <div className="mx-auto mb-12 h-[2px] w-56 bg-teal-600 sm:w-80 md:w-96 lg:w-[640px]" />
      </div>
    </section>
  );
}
